...
const myIds = [["js-11", "js-12", "js-13", "js-14", "js-15"],
              ["js-21", "js-22", "js-23", "js-24", "js-25"],
              ["js-31", "js-32", "js-33", "js-34", "js-35"],
              ["js-41", "js-42", "js-43", "js-44", "js-45"],
              ["js-51", "js-52", "js-53", "js-54", "js-55"]];
const revealIds = ["js-61", "js-62", "js-63", "js-64", "js-65"];
...
function findWord() { // computer finds his secret word
  const countWords = words5.length;
  let randomNumber = Math.floor(Math.random() * countWords);
  computerWord = words5[randomNumber].toUpperCase();
